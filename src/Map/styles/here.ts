...
export const getStyles = (apiKey: string) => {
  const styles = [
    {
      version: 8,
      name: "HERE Berlin",
      ...
      layers: [
        ...
        },
        {
          ...
          filter: [
            "match",
            ["get", "kind"],
            ["military", "industrial", "surface", "common"],
            true,
            false,
          ],
          layout: {
        ...
        },
        {
          ...
          paint: {
            "fill-extrusion-color": "hsl(0, 0%, 77%)",
...

    {
      ...
      sources: {
        omv: {
          ...
          maxzoom: 19,
          tiles: [
            "https://1.aerial.maps.api.here.com/maptile/2.1/maptile/newest/hybrid.day/{z}/{x}/{y}/512/png8?app_id=FQqMksczscHZmnVXWiWv&app_code=-_G1lyWmaZlbolo409QBTg",
          ],
          tileSize: 512,
        },
      },
...

    {
      ...
      sources: {
        omv: {
          ...
          maxzoom: 19,
          tiles: [
            "https://1.aerial.maps.api.here.com/maptile/2.1/maptile/newest/terrain.day/{z}/{x}/{y}/512/png8?app_id=FQqMksczscHZmnVXWiWv&app_code=-_G1lyWmaZlbolo409QBTg",
          ],
          tileSize: 512,
        },
      },
...

    {
      ...
      sources: {
        omv: {
          ...
          maxzoom: 19,
          tiles: [
            "https://1.traffic.maps.ls.hereapi.com/maptile/2.1/traffictile/newest/normal.day/{z}/{x}/{y}/256/png8?apiKey=mDI8QJCMDYlXmWmcU25JAXwb6haFx5ZMYOf21DVXlxk",
          ],
          tileSize: 256,
        },
      },
  ...
  return styles as StyleSpecification[];
};
