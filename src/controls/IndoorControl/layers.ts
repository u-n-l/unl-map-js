...
import ZoomLevel from "../../unlMap/models/ZoomLevel";
import {
...
export const venueUnitMarkersSymbolLayer: LayerSpecification = {
  ...
  layout: {
    ...
    "icon-image": [
      "step",
      ["zoom"],
      "venue-unit-marker-icon",
      16,
      "small-venue-unit-marker-icon",
      18,
      [
        "case",
        ["match", ["get", "category"], "elevator", true, false],
        "venue-elevator-marker-icon",
        ["match", ["get", "category"], "escalator", true, false],
        "venue-escalator-marker-icon",
        ["match", ["get", "category"], "stairs", true, false],
        "venue-stairs-marker-icon",
        ["match", ["get", "category"], "parking", true, false],
        "venue-parking-marker-icon",
        [
          "match",
          ["get", "category"],
        ...
        "venue-restroom-marker-icon",
        ["match", ["get", "category"], "steps", true, false],
        "venue-steps-marker-icon",
        "venue-unit-marker-icon",
      ],
    ],
    "text-font": ["Fira GO Regular"],
